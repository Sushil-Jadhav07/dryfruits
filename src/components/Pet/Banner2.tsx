        ...
        <>
            <div className="banner-block md:mt-20 mt-10 relative max-xl:h-[400px] max-lg:h-[280px] max-md:h-[240px]">
                ...
                <div className="text-content w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4">
                    <div className="heading1 text-center">A Taste of Tradition, A Promise of Purity</div>
                    <div className="heading6 font-normal text-center mt-2">Authentic dry fruits for your healthy lifestyle and festive needs.</div>
