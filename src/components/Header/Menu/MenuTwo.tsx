                ...
                <div className="container mx-auto h-full">
                    <div className="header-main flex justify-between h-full">
                        ...
                        <Link href={'/'} className='flex items-center'>
                            <Image src="/images/logomain.png" alt="" width={100} height={100} className='w-[30px] h-[30px] lg:w-[70px] lg:h-[70px]' />
                        </Link>
                            ...
                            <div className="list-nav mt-6">
                                <ul>
                                                        ...
                                                        {categories.map((category) => (
                                                            <li key={category._id}>
                                                                <Link 
                                                                    ...
                                                                    className={`text-secondary duration-300 ${pathname === `/categories/${category.slug?.current}` ? 'active' : ''}`}
                                                                >
                                                                    {category.name}
                                                                </Link>
                                                            </li>
                                    ...
                                    {brands && brands.length > 0 && (
                                        ...
                                        >
                                            <a href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Brands
                                                <span className='text-right'>
                                                    <Icon.CaretRight size={20} />
                                                </span>
                                            </a>
                                                        ...
                                                        {brands.map((brand) => (
                                                            <li key={brand._id}>
                                                                <Link 
                                                                    ...
                                                                    className={`text-secondary duration-300 ${pathname === `/brands/${brand.slug?.current}` ? 'active' : ''}`}
                                                                >
                                                                    {brand.name}
                                                                </Link>
                                                            </li>
