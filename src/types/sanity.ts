...
export interface SanityCategory {
  ...
  featured?: boolean
  sortOrder?: number
  brands?: SanityBrand[] // Brands in this category
  brandCount?: number
  productCount: number
}
...
export interface SanityBrand {
  ...
  products?: SanityProduct[] // Products by this brand
  productCount: number
}

// Hierarchical types for the complete flow
export interface SanityCategoryWithBrands extends SanityCategory {
  brands: SanityBrandWithProducts[]
}

export interface SanityBrandWithProducts extends SanityBrand {
  products: SanityProduct[]
}

export interface SanityProductInHierarchy {
  _id: string
  name: string
  slug: SanitySlug
  coverImage: SanityImage
...
export type CategoryHierarchy = SanityCategoryWithBrands[]
