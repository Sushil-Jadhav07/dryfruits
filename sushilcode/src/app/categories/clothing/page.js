...
const Clothing = () => {
	...
	useEffect(() => {
		const brandImageMap = {
			"Zara": "/images/brand/4.png",
			"H&M": "/images/brand/5.png",
			"Uniqlo": "/images/brand/Uniqlo.webp",
			"Levi's": "/images/brand/levis.webp",
	...
	return (
		<div id="header" className='relative w-full'>
			<MenuTwo />
			<BannerCollection url={"/images/banner/bannerCollection/clothes.webp"} title={"Clothing"} />
